...
class CommonLanguageSettingScreen extends HookConsumerWidget {
  const CommonLanguageSettingScreen({super.key});
                  ...
                  CoreButton(
                    ...
                    onPressed: () async {
                      await ref
                          ...
                          .saveCLAudioMode(selectedAudioMode.value);
                      await ref
                          .read(sessionManagerProvider)
                          .saveCLENGCHNInterval(int.parse(selectedENGCHNInterval
                              .value
                              .replaceAll("s", "")));
                      await ref.read(sessionManagerProvider).saveCLTextInterval(
                          int.parse(
