...
class SpecialLanguageSettingScreen extends HookConsumerWidget {
  const SpecialLanguageSettingScreen({super.key});
                  ...
                  CoreButton(
                    ...
                    onPressed: () async {
                      await ref
                          ...
                          .saveSLAudioMode(selectedAudioMode.value);
                      await ref
                          .read(sessionManagerProvider)
                          .saveSLENGCHNInterval(int.parse(selectedENGCHNInterval
                              .value
                              .replaceAll("s", "")));
                      await ref.read(sessionManagerProvider).saveSLTextInterval(
                          int.parse(
